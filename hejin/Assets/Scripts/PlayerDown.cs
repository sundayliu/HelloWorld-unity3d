...
public enum DownStatus { IDLE, WALK, UP, WALK_SHOOT_UP }
/// <summary>
/// 主角地面下蹲状态
/// </summary>
public class PlayerDown : MonoBehaviour
{
    ...
    public Transform shootPos_HorDown;
    ...
    public Sprite[] spLeg_Shoot;//下身射击，攻击
    ...
    public float animSpeedLeg_Shoot = 5;
    //动画间隔
    ...
    private float animIntervalLeg_Shoot = 5;
    //帧长度
    ...
    private int animLengthLeg_Shoot = 5;
    //计时器
    ...
    private float timerLeg_Shoot = 0;
    //帧
    ...
    private int animIndexLeg_Walk = 0;
    private int animIndexLeg_Shoot = 0;
    //上身状态
    ...
    void Start()
    {
        ...
        animIntervalLeg_Shoot = 1 / animSpeedLeg_Shoot;
        ...
        animLengthLeg_Shoot = spLeg_Shoot.Length;
    ...
    void Update()
    {
        ...
        switch (bodyStatus)
        {
            case BodyStatus.Hor_Shoot:
                ...
                if (timerBody_Hor_Shoot > animIntervalBody_Hor_Shoot)
                {
                    ...
                    if (animIndexBody_Hor_Shoot == animLengthBody_Hor_Shoot - 1)
                    {
                        Shoot();
        ...
        switch (legStatus)
        {
            ...
            case LegStatus.Walk:
                ...
                break;
            case LegStatus.DownShoot:

                timerLeg_Shoot += Time.deltaTime;
                if (timerLeg_Shoot > animIntervalLeg_Shoot)
                {
                    timerLeg_Shoot -= animIntervalLeg_Shoot;
                    animIndexLeg_Shoot++;
                    animIndexLeg_Shoot %= animLengthLeg_Shoot;
                    srLeg.sprite = spLeg_Shoot[animIndexLeg_Shoot];
                }
                break;
            default:
                break;
